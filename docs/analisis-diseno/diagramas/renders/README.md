...
| -------------------------------------------------------------------------- | ------------ | ------------------------------------------------------------------------ |
| [`01-clases.png`](01-clases.png)                                           | Clases       | 6 colecciones MongoDB, discriminator pattern, embeds, enums              |
...
| [`02c-casos-de-uso-repositorio.png`](02c-casos-de-uso-repositorio.png)     | Casos de Uso | M5A + M5B + M8 + M9: Repositorio, dashboard, notificaciones, chat        |
...
| [`03b-secuencia-procesamiento.png`](03b-secuencia-procesamiento.png)       | Secuencia    | Pipeline: Carga → OCR → NER → Almacenamiento (GridFS) → Notificación     |
| [`03c-secuencia-chat.png`](03c-secuencia-chat.png)                         | Secuencia    | Chat Inteligente: pregunta → tool calling → query MongoDB → respuesta IA |
| [`03d-secuencia-dashboard.png`](03d-secuencia-dashboard.png)               | Secuencia    | Dashboard: aggregations, filtros, exportación PDF                        |
| [`04a-actividad-pipeline.png`](04a-actividad-pipeline.png)                 | Actividad    | Pipeline OCR+NER con swimlanes por capa (GridFS)                         |
...
| [`05-estados-ciclo-vida.png`](05-estados-ciclo-vida.png)                   | Estados      | Ciclos de vida: archivo cargado y cuenta de usuario                      |
